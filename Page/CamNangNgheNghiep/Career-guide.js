/* ================================================================
   Career-guide.js
   ĐÃ SỬA: bỏ selector .btn-cta / .cta-form không tồn tại trong HTML
================================================================ */
...
const revealEls = document.querySelectorAll(
  '.topic-card, .feat-main, .feat-card, .article-card, .tool-card, .testi-card, .ai-card'
);
...
if (scoreArc) {
  ...
  const ring = document.querySelector('.tool-score-ring');
  if (ring) scoreObserver.observe(ring);
}

/* ── Load more articles ── */
const ARTICLE_DETAIL_URL = '../ChiTietCamNang/ArticleDetail.html';
  ...
  loadMoreBtn.addEventListener('click', function () {
    ...
    setTimeout(() => {
      ...
      moreArticles.forEach((a) => {
        ...
        card.innerHTML = `
          <a href="${ARTICLE_DETAIL_URL}" style="text-decoration:none;color:inherit;">
